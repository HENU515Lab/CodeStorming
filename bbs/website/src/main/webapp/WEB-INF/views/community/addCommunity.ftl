...
<#--                            </li>-->
                            ...
                            <li class="nav pull-right active" role="presentation">
                                <a href="/addCommunity.do?${logininfo.id}" class="user-myspace-base-subtitle">
                                    提问&nbsp;
...
<#--my-->
                        ...
                        <form id="add_a_solution_form" method="post" action="/submitCommunity.do" enctype="multipart/form-data">
                            <div class="row ui form">
                                <div class="col-xs-8">
                                    <input type="text" name="title" placeholder="标题，请抽象你的问题" maxlength="200" id="id_title">
                                </div>
                                <div class="col-xs-4">
                                    <input type="text" name="labels" placeholder="标签（逗号分隔）" maxlength="50" id="id_labels">
                                </div>
