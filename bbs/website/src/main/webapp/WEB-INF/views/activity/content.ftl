    ...
    <div class="container">
        <div class="panel panel-default copy-with-link">
            <div class="panel-body">
                ...
                <#list activity.activityContent as content>
                    <div class="panel panel-warning panel-week" id="week_${content.id}" style="cursor: pointer">
                        <div class="panel-heading">
                            <span class="week_title">${content.title}</span>
                            <span class="week_finish">

                    完成情况：${content.finish}/${activity.joinNum}
                </span>
                        </div>
                        <div class="panel-body">
                            <span class="nice_font">${content.activityContentAbstract}</span>

                        </div>
                    </div>

                    <div class="center-block" style="width: 95%; display: none;" id="week_panel_${content.id}">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        <#list activity.activityContent as content>
        $('#week_${content.id}').click(function () {
            $('#week_panel_${content.id}').toggle('slide', {direction: "up"}, 1000);
        });
        </#list>
...
<script type="text/javascript">
    <#list activity.activityContent as content>
    testEditormdView${content.id} = editormd.markdownToHTML("test-editormd-view-${content.id}", {
